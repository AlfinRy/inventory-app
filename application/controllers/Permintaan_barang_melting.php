...
class Permintaan_barang_melting extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template', 'content/permintaan_barang_melting/permintaan_barang_melting_data', $data);
        // print_r($data['bm']);
    }
    ...
    public function add()
    {
        ...
        if ($respon) {
            ...
            header('location:' . base_url('permintaan_barang_melting') . '?alert=success&msg=Selamat anda berhasil menambah Permintaan Barang Melting');
        } else {
            header('location:' . base_url('permintaan_barang_melting') . '?alert=error&msg=Maaf anda gagal menambah Permintaan Barang Melting');
        }
    }
    public function update()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Permintaan_barang_melting') . '?alert=success&msg=Selamat anda berhasil meng-update Permintaan Barang Melting');
        } else {
            header('location:' . base_url('Permintaan_barang_melting') . '?alert=error&msg=Maaf anda gagal meng-update Permintaan Barang Melting');
        }
    }
    public function delete($no_transfer_slip)
    {
        ...
        if ($respon) {
            header('location:' . base_url('permintaan_barang_melting') . '?alert=success&msg=Selamat anda berhasil menghapus Permintaan Barang Melting');
        } else {
            header('location:' . base_url('permintaan_barang_melting') . '?alert=error&msg=Maaf anda gagal menghapus Permintaan Barang Melting');
        }
