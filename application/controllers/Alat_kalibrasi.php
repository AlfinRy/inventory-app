...
class Alat_kalibrasi extends CI_Controller
{
	...
	public function add()
	{
		...
		if ($respon) {
			header('location:' . base_url('Alat_kalibrasi') . '?alert=success&msg=Selamat anda berhasil menambah Alat Kalibrasi');
		} else {
			header('location:' . base_url('Alat_kalibrasi') . '?alert=error&msg=Maaf anda gagal menambah Alat Kalibrasi');
		}
	}
	public function update()
	{
		...
		// echo $respon;
		if ($respon) {
			header('location:' . base_url('Alat_kalibrasi') . '?alert=success&msg=Selamat anda berhasil meng-update Alat Kalibrasi');
		} else {
			header('location:' . base_url('Alat_kalibrasi') . '?alert=error&msg=Maaf anda gagal meng-update Alat Kalibrasi');
		}
	}
	public function delete($id_kalibrasi)
	{
		...
		if ($respon) {
			header('location:' . base_url('Alat_kalibrasi') . '?alert=success&msg=Selamat anda berhasil menghapus Alat Kalibrasi');
		} else {
			header('location:' . base_url('Alat_kalibrasi') . '?alert=error&msg=Maaf anda gagal menghapus Alat Kalibrasi');
		}
	}
