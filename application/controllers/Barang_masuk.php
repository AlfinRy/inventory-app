...
class Barang_masuk extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($respon) {
            ...
            header('location:' . base_url('barang_masuk') . '?alert=error&msg=Maaf anda gagal menambah Barang Masuk');
        }
        // echo json_encode($data);
        // die;
    }
    public function update()
    {
        ...
        if ($respon) {
            ...
            header('location:' . base_url('Barang_masuk') . '?alert=error&msg=Maaf anda gagal meng-update Barang Masuk');
        }
    }
    public function delete($id_barang_masuk)
    {
        ...
        if ($respon) {
            ...
            header('location:' . base_url('barang_masuk') . '?alert=error&msg=Maaf anda gagal menghapus Barang Masuk');
        }
    }
