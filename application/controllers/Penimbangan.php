...
class Penimbangan extends CI_Controller
{
	...
	public function add()
	{
		...
		if ($respon) {
			header('location:' . base_url('Penimbangan') . '?alert=success&msg=Selamat anda berhasil menambah Bahan Penimbangan');
		} else {
			header('location:' . base_url('Penimbangan') . '?alert=error&msg=Maaf anda gagal menambah Bahan Penimbangan');
		}
	}
	public function update()
	{
		...
		if ($respon) {
			header('location:' . base_url('Penimbangan') . '?alert=success&msg=Selamat anda berhasil meng-update Bahan Penimbangan');
		} else {
			header('location:' . base_url('Penimbangan') . '?alert=error&msg=Maaf anda gagal meng-update Bahan Penimbangan');
		}
	}
	...
	public function delete($id_ts_melt)
	{
		...
		if ($respon) {
			header('location:' . base_url('Penimbangan') . '?alert=success&msg=Selamat anda berhasil menghapus Bahan Penimbangan');
		} else {
			header('location:' . base_url('Penimbangan') . '?alert=success&msg=Maaf anda gagal menghapus Bahan Penimbangan');
		}
	}
}
