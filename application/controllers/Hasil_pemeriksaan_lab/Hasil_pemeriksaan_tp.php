...
class hasil_pemeriksaan_tp extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('M_hasil_pemeriksaan/M_hasil_pemeriksaan_tp');
    ...
    public function add_ujitp()
    {
        ...
        if ($respon) {
            header('location:' . base_url('pemeriksaan_bahan') . '?alert=success&msg=Selamat anda berhasil melakukan Uji Bahan Tinta Print');
        } else {
            header('location:' . base_url('pemeriksaan_bahan') . '?alert=error&msg=Maaf anda gagal melakukan Uji Bahan Tinta Print');
        }
    }
    ...
    public function add()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_tp') . '?alert=success&msg=Selamat anda berhasil menambah Barang Masuk Bahan Pewarna');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_tp') . '?alert=error&msg=Maaf anda gagal menambah Barang Masuk Bahan Pewarna');
        }
    }
    ...
    public function ditolak()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_tp') . '?alert=success&msg=Selamat anda berhasil Reject Bahan Pewarna');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_tp') . '?alert=error&msg=Maaf anda gagal Reject Bahan Pewarna');
        }
    }
