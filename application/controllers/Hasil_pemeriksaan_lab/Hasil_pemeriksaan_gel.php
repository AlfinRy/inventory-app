...
class hasil_pemeriksaan_gel extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('M_hasil_pemeriksaan/M_hasil_pemeriksaan_gel');
    ...
    public function add_ujigel()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Pemeriksaan_bahan') . '?alert=success&msg=Selamat anda berhasil melakukan Uji Bahan Gelatin (Bahan Baku)');
        } else {
            header('location:' . base_url('Pemeriksaan_bahan') . '?alert=error&msg=Maaf anda gagal melakukan Uji Bahan Gelatin (Bahan Baku)');
        }
    }
    ...
    public function add()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_gel') . '?alert=success&msg=Selamat anda berhasil menambah Barang Masuk Bahan Gelatin (Bahan Baku)');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_gel') . '?alert=error&msg=Maaf anda gagal menambah Barang Masuk Bahan Gelatin (Bahan Baku)');
        }
    }
    ...
    public function ditolak()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_gel') . '?alert=success&msg=Selamat anda berhasil Reject Bahan Gelatin (Bahan Baku)');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_gel') . '?alert=danger&msg=Maaf anda gagal Reject Bahan Gelatin (Bahan Baku)');
        }
    }
