...
class hasil_pemeriksaan_bt_mp extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('M_hasil_pemeriksaan/M_bahan_tambahan/M_hasil_pemeriksaan_bt_mp');
    ...
    public function add_ujimp()
    {
        ...
        if ($respon) {
            header('location:' . base_url('pemeriksaan_bahan') . '?alert=success&msg=Selamat anda berhasil melakukan Uji Bahan Tambahan (Methyl Paraben)');
        } else {
            header('location:' . base_url('pemeriksaan_bahan') . '?alert=error&msg=Maaf anda gagal melakukan Uji Bahan Tambahan (Methyl Paraben)');
        }
    }
    ...
    public function add()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_mp') . '?alert=success&msg=Selamat anda berhasil menambah Barang Masuk Bahan Tambahan');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_mp') . '?alert=error&msg=Maaf anda gagal menambah Barang Masuk Bahan Tambahan');
        }
    }
    ...
    public function ditolak()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_mp') . '?alert=success&msg=Selamat anda berhasil Reject Bahan Tambahan');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_mp') . '?alert=error&msg=Maaf anda gagal Reject Bahan Tambahan');
        }
    }
