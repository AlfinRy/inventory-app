...
class hasil_pemeriksaan_bt_la extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('M_hasil_pemeriksaan/M_bahan_tambahan/M_hasil_pemeriksaan_bt_la');
    ...
    public function add_ujila()
    {
        ...
        if ($respon) {
            header('location:' . base_url('pemeriksaan_bahan') . '?alert=success&msg=Selamat anda berhasil Uji Bahan Tambahan (Lecithin Adlec)');
        } else {
            header('location:' . base_url('pemeriksaan_bahan') . '?alert=error&msg=Maaf anda gagal Uji Bahan Tambahan (Lecithin Adlec)');
        }
    }
    ...
    public function add()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_la') . '?alert=success&msg=Selamat anda berhasil menambah Barang Masuk Bahan Tambahan');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_la') . '?alert=error&msg=Maaf anda gagal menambah Barang Masuk Bahan Tambahan');
        }
    }
    ...
    public function ditolak()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_la') . '?alert=success&msg=Selamat anda berhasil Reject Bahan Tambahan');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_la') . '?alert=error&msg=Maaf anda gagal Reject Bahan Tambahan');
        }
    }
