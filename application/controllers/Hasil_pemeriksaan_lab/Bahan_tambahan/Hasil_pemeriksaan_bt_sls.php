...
class hasil_pemeriksaan_bt_sls extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('M_hasil_pemeriksaan/M_bahan_tambahan/M_hasil_pemeriksaan_bt_sls');
    ...
    public function add_ujisls()
    {
        ...
        if ($respon) {
            header('location:' . base_url('pemeriksaan_bahan') . '?alert=success&msg=Selamat anda berhasil melakukan Uji Bahan Tambahan (Sodium Launil Sulfat)');
        } else {
            header('location:' . base_url('pemeriksaan_bahan') . '?alert=error&msg=Maaf anda gagal melakukan Uji Bahan Tambahan (Sodium Launil Sulfat)');
        }
    }
    ...
    public function add()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls') . '?alert=success&msg=Selamat anda berhasil menambah Barang Masuk Bahan Tambahan');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls') . '?alert=error&msg=Maaf anda gagal menambah Barang Masuk Bahan Tambahan');
        }
    }
    ...
    public function ditolak()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls') . '?alert=success&msg=Selamat anda berhasil Reject Bahan Tambahan');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls') . '?alert=error&msg=Maaf anda gagal Reject Bahan Tambahan');
        }
    }
