...
class hasil_pemeriksaan_pel extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('M_hasil_pemeriksaan/M_hasil_pemeriksaan_pel');
    ...
    public function add_ujipel()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Pemeriksaan_bahan') . '?alert=success&msg=Selamat anda berhasil melakukan Uji Bahan Pelarut');
        } else {
            header('location:' . base_url('Pemeriksaan_bahan') . '?alert=error&msg=Maaf anda gagal melakukan Uji Bahan Pelarut');
        }
    }
    ...
    public function add()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_pel') . '?alert=success&msg=Selamat anda berhasil menambah Barang Masuk Bahan Pelarut');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_pel') . '?alert=error&msg=Maaf anda gagal menambah Barang Masuk Bahan Pelarut');
        }
    }
    ...
    public function ditolak()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_pel') . '?alert=success&msg=Selamat anda berhasil Reject Bahan Pelarut');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_pel') . '?alert=error&msg=Maaf anda gagal Reject Bahan Pelarut');
        }
    }
