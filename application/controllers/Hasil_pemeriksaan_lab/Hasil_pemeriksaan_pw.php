...
class hasil_pemeriksaan_pw extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('M_hasil_pemeriksaan/M_hasil_pemeriksaan_pw');
    ...
    public function add_ujipw()
    {
        ...
        if ($respon) {
            header('location:' . base_url('pemeriksaan_bahan') . '?alert=success&msg=Selamat anda berhasil melakukan Uji Bahan Pewarna');
        } else {
            header('location:' . base_url('pemeriksaan_bahan') . '?alert=error&msg=Maaf anda gagal melakukan Uji Bahan Pewarna');
        }
    }
    ...
    public function add()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_pw') . '?alert=success&msg=Selamat anda berhasil menambah Barang Masuk Bahan Pelarut');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_pw') . '?alert=error&msg=Maaf anda gagal menambah Barang Masuk Bahan Pelarut');
        }
    }
    ...
    public function ditolak()
    {
        ...
        if ($respon) {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_pw') . '?alert=success&msg=Selamat anda berhasil Reject Bahan Pewarna');
        } else {
            header('location:' . base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_pw') . '?alert=error&msg=Maaf anda gagal Reject Bahan Pewarna');
        }
    }
