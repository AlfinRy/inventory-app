...
class M_penimbangan extends CI_Model
{
    ...
    public function add($data)
    {
        ...
        $sql = "
        INSERT INTO `tb_penimbangan`(`id_mm`, `id_kalibrasi`,`id_ts_melt`, `qty_dibutuhkan`,`qty_ditimbang`,`tgl_timbang`,`label_kebersihan`,`label_kalibrasi`,`op_penimbangan`,`created_at`, `created_by`, `updated_at`, `updated_by`, `is_deleted`) 
        VALUES ('$data[id_mm]','$data[id_kalibrasi]','$data[id_transaksi]','$data[qty_dibutuhkan]','$data[qty_ditimbang]','$data[tgl_timbang]','$data[label_kebersihan]','$data[label_kalibrasi]','$data[op_penimbangan]',NOW(),'$id_user','0000-00-00 00:00:00','','0')
        ";
