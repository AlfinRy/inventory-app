            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?= base_url('Permintaan_barang_melting') ?>">Permintaan Barang Melting</a></li>
                </ul>
              </div>
            </div>
          </div>
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                <?php if ($jabatan === "admin" || $jabatan === "supervisor") { ?>
                                  ...
                                  <div class="btn-group" role="group" aria-label="Basic example">
                                    <a type="button" class="btn btn-danger btn-square text-light btn-sm" href="<?= base_url() ?>permintaan_barang_melting/delete/<?= str_replace('/', '--', $k['no_transfer_slip']) ?>" onclick="if (! confirm('Apakah Anda Yakin?')) { return false; }">
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url() ?>Permintaan_barang_melting/add">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#no_transfer_slip").keyup(function() {
      ...
      jQuery.ajax({
        url: "<?= base_url() ?>permintaan_barang_melting/cek_transfer_slip",
        dataType: 'text',
        type: "post",
        data: {
...
<div class="modal fade" id="view" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url() ?>permintaan_barang_melting/update">
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#view').on('show.bs.modal', function(event) {
      ...
      jQuery.ajax({
        url: "<?= base_url() ?>permintaan_barang_melting/data_permintaan_barang",
        dataType: 'json',
        type: "post",
        data: {
          no_transfer_slip: no_transfer_slip
