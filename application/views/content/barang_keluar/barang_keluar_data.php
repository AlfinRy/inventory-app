                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url() ?>">Barang Keluar</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        ...
        $('#export').click(function() {
            ...
            if (filter_tgl == '' && filter_tgl2 != '') {
                ...
                var url = "<?= base_url() ?>Laporan_barang_masuk/pdf_print_schedule";
                window.open(url, 'pdf_print_schedule', 'location=yes,height=700,width=1300,scrollbars=yes,status=yes');
            } else {

                var url = "<?= base_url() ?>Laporan_barang_masuk/pdf_print_schedule/" + newFilterTgl + "/" + newFilterTgl2;
