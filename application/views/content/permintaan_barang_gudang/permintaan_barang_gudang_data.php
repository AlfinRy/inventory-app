                          ...
                          ?>
                            <tr>
                              ...
                              <td class="text-center">
                                <?php if ($level === "admin") { ?>
                                  <div class="btn-group" role="group" aria-label="Basic example">
                                    <a type="button" class="btn btn-danger btn-square text-light btn-sm" href="<?= base_url() ?>Permintaan_barang_gudang/delete/<?= str_replace('/', '--', $k['no_transfer_slip']) ?>" onclick="if (! confirm('Apakah Anda Yakin?')) { return false; }">
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#view').on('show.bs.modal', function(event) {
      ...
      jQuery.ajax({
        url: "<?= base_url() ?>permintaan_barang_gudang/data_permintaan_barang",
        dataType: 'json',
        type: "post",
        data: {
...
<div class="modal fade" id="disetujui" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url() ?>Permintaan_barang_gudang/disetujui">
        <input type="hidden" id="e_id_barang_masuk" name="id_barang_masuk">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-4">
...
<div class="modal fade" id="tidakdisetujui" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url() ?>Permintaan_barang_gudang/ditolak">
        <input type="hidden" id="e_id_barang_masuk" name="id_barang_masuk">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-4">
