            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?= base_url('Laporan_kartu_stok') ?>">Kartu Stok</a></li>
                </ul>
              </div>
            </div>
          </div>
  ...
  $(document).ready(function() {
    ...
    $('#export').click(function() {
      ...
      if (filter_tgl == '' && filter_tgl2 != '') {
        ...
        var url = "<?= base_url() ?>Laporan_kartu_stok/pdf_laporan_kartu_stok/" + newFilterTgl + "/" + newFilterTgl2;
