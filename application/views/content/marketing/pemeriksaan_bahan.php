                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url('Pemeriksaan_bahan') ?>">Lab/QC</a></li>
                                    <li class="breadcrumb-item"><a href="<?= base_url('Pemeriksaan_bahan') ?>">Pemeriksaan Bahan</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($result as $k) {
                                                        ...
                                                        <?php if ($k['status'] === "Karantina") { ?>
                                                            ...
                                                            <td class="text-right">
                                                                <?php if ($k['jenis_bahan'] === "Bahan Baku" || $k['jenis_bahan'] === "BAHAN BAKU" && $k['status'] === "Karantina") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <?php }
                                                                if ($k['jenis_bahan'] === "Pelarut" || $k['jenis_bahan'] === "PELARUT" && $k['status'] === "Karantina") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <?php }
                                                                if ($k['jenis_bahan'] === "Pewarna" || $k['jenis_bahan'] === "PEWARNA" && $k['status'] === "Karantina") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <?php }
                                                                if ($k['jenis_bahan'] === "Tinta Print" || $k['jenis_bahan'] === "TINTA PRINT" && $k['status'] === "Karantina") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                if ($k['nama_barang'] === "Natrium Benzoat" || $k['nama_barang'] === "NATRIUM BENZOAT" && $k['status'] === "Karantina") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                if ($k['nama_barang'] === "Methyl Paraben" || $k['jenis_bahan'] === "METHYL PARABEN" && $k['status'] === "Karantina") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                if ($k['nama_barang'] === "Lecithin Adlec" || $k['jenis_bahan'] === "LECITHIN ADLEC" && $k['status'] === "Karantina") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                if ($k['nama_barang'] === "Candurin Silver Fine" || $k['jenis_bahan'] === "CANDURIN SILVER FINE" && $k['status'] === "Karantina") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                if ($k['nama_barang'] === "Sodium Launil Sulfat" || $k['jenis_bahan'] === "SODIUM LAUNIL SULFAT" && $k['status'] === "Karantina") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                if ($k['nama_barang'] === "Titanium Dioxide" || $k['jenis_bahan'] === "TITANIUM DIOXIDE" && $k['status'] === "Karantina") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
