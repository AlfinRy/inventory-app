            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?= base_url('Barang_masuk_melting/Bm_bahan_tambahan/Mm_bt_csf') ?>">Barang Masuk Melting</a></li>
                </ul>
              </div>
            </div>
          </div>
                  ...
                  <div class="card-header">
                    ...
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="<?= base_url('Barang_masuk_melting/mm_bahan_baku') ?>">Bahan Baku</a>
                        <a class="dropdown-item" href="<?= base_url('Barang_masuk_melting/mm_pel') ?>">Pelarut</a>
                        <a class="dropdown-item" href="<?= base_url('Barang_masuk_melting/mm_pw') ?>">Pewarna</a>
                        <a class="dropdown-item" href="<?= base_url('Barang_masuk_melting/mm_tp') ?>">Tinta Print</a>
                        <a class="dropdown-item" href="<?= base_url('Barang_masuk_melting/Bm_bahan_tambahan/mm_bt_nb') ?>">Bahan Tambahan</a>
                      </div>
                    </div><br>
                    ...
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu scrollable-menu" role="menu">
                        <a class="dropdown-item" href="<?= base_url('Barang_masuk_melting/Bm_bahan_tambahan/mm_bt_nb') ?>">Natrium Benzoat</a>
                        <a class="dropdown-item" href="<?= base_url('Barang_masuk_melting/Bm_bahan_tambahan/mm_bt_mp') ?>">Methyl Paraben</a>
                        <a class="dropdown-item" href="<?= base_url('Barang_masuk_melting/Bm_bahan_tambahan/mm_bt_la') ?>">Lecithin Adlec</a>
                        <a class="dropdown-item" href="<?= base_url('Barang_masuk_melting/Bm_bahan_tambahan/mm_bt_csf') ?>">Candurin Silver Fine</a>
                        <a class="dropdown-item" href="<?= base_url('Barang_masuk_melting/Bm_bahan_tambahan/mm_bt_sls') ?>">Sodium Launil Sulfat</a>
                        <a class="dropdown-item" href="<?= base_url('Barang_masuk_melting/Bm_bahan_tambahan/mm_bt_td') ?>">Titanium Dioxide</a>
                      </div>
                    </div><br>
                  </div>
