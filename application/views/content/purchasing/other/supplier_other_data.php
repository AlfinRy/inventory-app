                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php if ($level === "admin") { ?>
                                                                    ...
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a type="button" class="btn btn-danger btn-square text-light btn-sm" href="<?= base_url() ?>supplier/delete/<?= $k['id_supplier'] ?>" onclick="if (! confirm('Apakah Anda Yakin?')) { return false; }">
