            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?= base_url('Alat_kalibrasi') ?>">Alat Kalibrasi</a></li>
                </ul>
              </div>
            </div>
          </div>
                            ...
                            <tr class="table-row">
                              ...
                              <td class="text-center">
                                <?php if ($jabatan === "admin" || $jabatan === "operator" || $jabatan === "supervisor") { ?>
                                  ...
                                  <div class="btn-group" role="group">
                                    <a href="<?= base_url() ?>Alat_kalibrasi/delete/<?= $k['id_kalibrasi'] ?>" class="btn btn-danger btn-square text-light btn-sm" onclick="if (! confirm('Apakah Anda Yakin?')) { return false; }">
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url() ?>Alat_kalibrasi/add">
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url() ?>Alat_kalibrasi/update">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
