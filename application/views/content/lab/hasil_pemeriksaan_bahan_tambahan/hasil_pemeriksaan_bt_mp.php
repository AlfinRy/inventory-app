                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="<?= base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_bt_nb') ?>">Bahan Tambahan</a>
                                            </div>
                                        </div><br>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <?php if ($k['status'] === "Released") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a type="button" class="btn btn-success btn-square btn-sm text-light" onclick="window.open(`<?= base_url() ?>Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_mp/pdf_label_released/<?= str_replace('/', '--', $k['no_surat_jalan']) ?>`, 'location=yes,height=700,width=1300,scrollbars=yes,status=yes'); " data-id_pb="<?= $k['id_pb'] ?>" data-no_batch="<?= $k['no_batch'] ?>" data-no_surat_jalan="<?= $k['no_surat_jalan'] ?>">
                                                                ...
                                                                <?php if ($k['status'] === "Di Tolak") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a type="button" class="btn btn-danger btn-square btn-sm text-light" onclick="window.open(`<?= base_url() ?>Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_mp/pdf_label_reject/<?= str_replace('/', '--', $k['no_surat_jalan']) ?>`, 'location=yes,height=700,width=1300,scrollbars=yes,status=yes'); " data-id_pb="<?= $k['id_pb'] ?>" data-no_batch="<?= $k['no_batch'] ?>" data-no_surat_jalan="<?= $k['no_surat_jalan'] ?>">
                                                                            <i class="feather icon-file"></i>Print Label
                                                                        </a>
                                                                    </div>
                                                                <?php } ?>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <?php if ($k['status'] === "Released" || $k['status'] === "Di Tolak") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a type="button" class="btn btn-warning btn-square btn-sm text-light" onclick="window.open(`<?= base_url() ?>Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_mp/pdf_label_hasil/<?= str_replace('/', '--', $k['no_surat_jalan']) ?>`, 'location=yes,height=700,width=1300,scrollbars=yes,status=yes'); " data-id_pb="<?= $k['id_pb'] ?>" data-no_batch="<?= $k['no_batch'] ?>" data-no_surat_jalan="<?= $k['no_surat_jalan'] ?>">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="post" action="<?= base_url() ?>Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_mp/add">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="post" action="<?= base_url() ?>Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_mp/ditolak">
