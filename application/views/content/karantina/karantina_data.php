                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url('Karantina') ?>">Barang Karantina</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    ?>
                                                        <?php if ($k['status'] === "Karantina") { ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a type="button" class="btn btn-success btn-square text-light btn-sm" onclick="window.open(`<?= base_url() ?>karantina/pdf_label_karantina/<?= str_replace('/', '--', $k['no_surat_jalan']) ?>`, 'location=yes,height=700,width=1300,scrollbars=yes,status=yes'); ">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="no_batch" name="no_batch" placeholder="No Batch" maxlength="20" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="no_surat_jalan" name="no_surat_jalan" value="../XII/2022" maxlength="20" aria-describedby="validationServer03Feedback" autocomplete="off" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="cara_lamar">Dokumen Pendukung</label>
                                <div class="form-check mr-2">
                                    <input class="form-check-input" name="dok_pendukung[]" type="checkbox" value="COA">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="jml_kemasan" name="jml_kemasan" placeholder="Jumlah Kemasan" onkeypress="return hanyaAngka(event)" maxlength="15" autocomplete="off" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="qty" name="qty" placeholder="Jumlah Kemasan" onkeypress="return hanyaAngka(event)" maxlength="15" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="tutup" value="Rapat"> Rapat <br>
                                                <input class="form-check-input" type="radio" name="tutup" value="Tidak Rapat"> Tidak Rapat
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="wadah" value="Rusak"> Rusak <br>
                                                <input class="form-check-input" type="radio" name="wadah" value="Tidak Rusak"> Tidak Rusak
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="label" value="Terbaca"> Terbaca <br>
                                                <input class="form-check-input" type="radio" name="label" value="Tidak Terbaca"> Tidak Terbaca
                                            </div>
                                        </div>
                                    </div>
                                </div>
