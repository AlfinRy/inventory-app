        ...
        <div class="navbar-content scroll-div">
            ...
            <ul class="nav pcoded-inner-navbar" style="list-style: none;">
                    ...
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class="nav-item <?= $uri == 'pemeriksaan_bahan' ? 'active' : '' ?>">
                                <a href="<?= base_url('pemeriksaan_bahan') ?>" class="pcoded-mtext">Pemeriksaan Bahan
                            ...
                            <li class="nav-item <?= $uri == 'hasil_pemeriksaan' ? 'active' : '' ?>">
                                <a href="<?= base_url('Hasil_pemeriksaan_lab/Hasil_pemeriksaan_gel') ?>" class="">Hasil Pemeriksaan
                                    <?php if ($cek_proses != 0) { ?>
                            ...
                            <li class="nav-item <?= $uri == 'alat_kalibrasi' ? 'active' : '' ?>">
                                <a href="<?= base_url('Alat_kalibrasi') ?>" class="">Alat Kalibrasi</a>
                            </li>
                        </ul>
                    </li>
                <?php } ?>
                    ...
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="nav-item <?= $uri == 'barang' ? 'active' : '' ?>"><a href="<?= base_url('Barang') ?>" class="">Bahan</a></li>
                            ...
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="nav-item <?= $uri == 'barang' ? 'active' : '' ?>"><a href="<?= base_url('Barang') ?>" class="">Sparepart</a></li>
                                    <li class="nav-item <?= $uri == 'supplier' ? 'active' : '' ?>"><a href="<?= base_url('supplier') ?>" class="">Supplier</a></li>
                                    <li class="nav-item <?= $uri == 'pembelian' ? 'active' : '' ?>"><a href="<?= base_url('pembelian') ?>" class="">Pembelian</a></li>
                                </ul>
                            </li>
                        ...
                        <ul class="pcoded-submenu">
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="nav-item  <?= $uri == 'karantina' ? 'active' : '' ?>"><a href="<?= base_url('karantina') ?>" class="">Karantina</a></li>
                                    <li class="nav-item <?= $uri == 'barang_stok' ? 'active' : '' ?>"><a href="<?= base_url('barang_stok') ?>" class="">Stok Barang</a></li>
                                    <li class="nav-item  <?= $uri == 'permintaan_barang_gudang' ? 'active' : '' ?>">
                                        <a href="<?= base_url('permintaan_barang_gudang') ?>" class="">Permintaan Barang Gudang
                                            <?php if ($cek_permintaan != 0) { ?>
                                                <span id="badge-hp" class="badge badge-pill badge-warning"><?= $cek_permintaan ?></span>
                                            <?php } ?>
                                        </a>
                            ...
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="nav-item <?= $uri == 'Laporan Barang Masuk' ? 'active' : '' ?>"><a href="<?= base_url('Laporan_barang_masuk') ?>" class="">Barang Masuk</a></li>
                                    <li class="nav-item <?= $uri == 'Laporan Barang Keluar' ? 'active' : '' ?>"><a href="<?= base_url('Laporan_barang_keluar') ?>" class="">Barang Keluar</a></li>
                                    <li class="nav-item  <?= $uri == 'Laporan Kartu Stok' ? 'active' : '' ?>"><a href="<?= base_url('Laporan_kartu_stok') ?>" class="">Kartu Stok</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="pcoded-submenu">
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="nav-item  <?= $uri == 'barang_masuk_melting' ? 'active' : '' ?>"><a href="<?= base_url('Barang_masuk_melting/mm_bahan_baku') ?>" class="">Barang Masuk Melting</a></li>
                                </ul>
                            </li>
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="nav-item <?= $uri == 'penimbangan' ? 'active' : '' ?>"><a href="<?= base_url('penimbangan') ?>" class="">Penimbangan</a></li>
                                    <li class="nav-item <?= $uri == 'masak_gelatin' ? 'active' : '' ?>"><a href="<?= base_url('Masak_gelatin') ?>" class="">Masak Gelatin</a></li>
                                    <li class="nav-item <?= $uri == 'pewarnaan' ? 'active' : '' ?>"><a href="<?= base_url('Pewarnaan') ?>" class="">Pewarnaan</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                ...
                <?php if ($level === "admin") { ?>
                    ...
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        <a href="javascript:" class="nav-link "><span class="pcoded-micon"><i class="feather icon-package"></i></span><span class="pcoded-mtext">QA</span></a>
                        <ul class="pcoded-submenu">
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
